...
import 'package:teknofest_helen_project_/models/place_model.dart';
...
class _DiscoverPageState extends State<DiscoverPage> {
  ...
  final List<String> _imgList = [
    ...
    "assets/images/istanbul1.jpeg",
    "assets/images/istanbul2.jpeg",
  ];
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          PlaceInfo place = placeList[index];
                          return Padding(
                            padding: const EdgeInsets.only(right: 5.0),
                            child: Row(
                              children: [
                                placeCard(
                                  placeInfo: placeList[index],
                                  press: () {},
                                ),
                              ],
                            ),
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: IconButton(
                            onPressed: () {
                              placeInfo.isFavorite = !placeInfo.isFavorite;
                            },
                            icon: Icon(
                              Icons.favorite,
                              color: placeInfo.isFavorite
                                  ? Color(0xff4C7972)
                                  : Colors.black,
                            ),
                          ),
