...
import '../models/place_model_ankara.dart';
import '../onboarding/size_config.dart';
import 'home_page.dart';

class DiscoverPageAnkaraSearch extends StatefulWidget {
  DiscoverPageAnkaraSearch({Key? key}) : super(key: key);

  @override
  State<DiscoverPageAnkaraSearch> createState() => _DiscoverPageAnkaraSearchState();
}

class _DiscoverPageAnkaraSearchState extends State<DiscoverPageAnkaraSearch> {
   int _currentPage = 0;
